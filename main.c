...
int main()
{
  ...
  POS   curseur; //POSITION DU CURSEUR (Arrivee)
  POS   pions; //POSITION DES PIONS (Depart)
  POS   manger; //COMPTER LES PIONS
  ...
  /*ECRIT LE PETIT TEXTE D'AIDE*/
  gotoxy(44,18);
  printf("Utilisez les touches %c %c %c %c",24,25,26,27);
  gotoxy(44,19);
  printf("pour faire bouger le curseur,");
  gotoxy(44,20);
  printf("ENTER pour s\x82lectionner un pion");
  gotoxy(44,21);
  printf("ou une case,");
  gotoxy(44,22);
  printf("ESPACE pour changer de pion");
  gotoxy(44,23);
  printf("et ECHAP pour afficher le menu.");
  gotoxy(1,24);
  ...
  while (sortie!=0)
  {
    ...
    for (increment=0 ; increment<=9 ; increment++)
    {
      for (increment2=0 ; increment2<=9 ; increment2++)
      {
        ...
        if ((damier[increment2][increment]==PION_J1)||(damier[increment2][increment]==DAME_J1)) textcolor(couleurs[1]);
    ...
    for (increment=0 ; increment<=9 ; increment++)
    {
      for (increment2=0 ; increment2<=9 ; increment2++)
      {
        if ((damier[increment2][increment]==DAME_J1)/*DAME_J1='\x01'*/
        ||  (damier[increment2][increment]==PION_J1))/*PION_J1='\x05'*/
            manger.A++;
        if ((damier[increment2][increment]==DAME_J2)/*DAME_J2='\x02'*/
        ||  (damier[increment2][increment]==PION_J2))/*PION_J2='\x06'*/
            manger.B++;
      }
    }
    ...
    /*SI UN DES JOUEURS A PERDU TOUS SES PIONS*/
    ...
    switch(touche)
    {
      ...
      case GAUCHE: curseur.A=curseur.X;
                   curseur.B=curseur.Y;
                   curseur.X--;
                   if (curseur.X==-1) curseur.X=9;
                   break;
      /*DROITE*/
      case DROITE: curseur.A=curseur.X;
                   curseur.B=curseur.Y;
                   curseur.X++;
                   if (curseur.X==10) curseur.X=0;
                   break;
      /*HAUT*/
      case HAUT:   curseur.A=curseur.X;
                   curseur.B=curseur.Y;
                   curseur.Y--;
                   if (curseur.Y==-1) curseur.Y=9;
                   break;
      /*BAS*/
      case BAS:    curseur.A=curseur.X;
                   curseur.B=curseur.Y;
                   curseur.Y++;
                   if (curseur.Y==10) curseur.Y=0;
                   break;
      /*ENTER*/
      ...
      case ESCAPE: textcolor(couleurs[3]);
                   ...
                   //dessine_menu(30,8);///dans le menu il faudrait rajouter la sauvegarde, le chargement et l'IA
                   dessine_menu(30,7);
                   choix=0;
                   menu=1;
                   /*MENU*/
                   while (menu!=0)
                   {
                     ...
                     /*SI UNE COULEUR A ETE CHANGEE REDESSINER TOUT*/
                     if (menu==2)
                     {
                       textcolor(couleurs[0]);
                       ...
                       for (increment=0 ; increment<=9 ; increment++)
                       {
                         ...
                         {
                           gotoxy((increment2*4)+4,(increment*2)+3);
                           if (damier[increment2][increment]==PION_J1) textcolor(couleurs[1]);
                           else textcolor(couleurs[2]);
                           printf("%c",damier[increment2][increment]);
                         }
                       }
    ...
    if ((action==2)||(action==3))
    {
      ...
      if ( (damier[curseur.X][curseur.Y]!=' ') && ((action==2)||(action==3)) )
      {
        ...
        gotoxy(47,6);
        textcolor(couleurs[tour]);
        printf("Cette case est d\x82\x20\bj\x85 occup\x82\x20\be !");
        action=action+2;
      }
      /*SINON*/
      if ( (damier[curseur.X][curseur.Y]==' ') && ((action==2)||(action==3)) )
      {
        ...
        if (action==2)
        {
          ...
          && ( ((curseur.Y==pions.Y+1)&&(tour==1)) || ((curseur.Y==pions.Y-1)&&(tour==2)) ))
          {
            ...
            if (tour==1) damier[curseur.X][curseur.Y]=PION_J1;
            else damier[curseur.X][curseur.Y]=PION_J2;
            dessine_menu(31,2);
            gotoxy(47,6);
            textcolor(couleurs[tour]);
            ...
            for (increment=0 ; increment<=9 ; increment=increment+9)
            {
              for (increment2=0 ; increment2<=9 ; increment2++)
              {
                if (((damier[increment2][increment]==PION_J1)&&(increment==9))
                ||((damier[increment2][increment]==PION_J2)&&(increment==0)))
                {
                  ...
                  if (increment==9) damier[increment2][increment]=DAME_J1;
                  if (increment==0) damier[increment2][increment]=DAME_J2;
                  textcolor(couleurs[3]);
                  dessine_menu(20,2);
                  gotoxy(47,6);
                  if (tour==1) textcolor(couleurs[2]);
                  else textcolor(couleurs[1]);
                  printf("Bravo ! Le joueur %d",(tour==1)?2:1);
                  gotoxy(47,7);
          ...
          &&(action==2))
          {
            /*DETERMINE LA DIRECTION DANS LAQUELLE LE PION DOIT AVANCER POUR MANGER LE PION*/
            if (curseur.X==pions.X+2) pions.A=1;
            else pions.A=-1;
            if (curseur.Y==pions.Y+2) pions.B=1;
            else pions.B=-1;
            /*SI VEUT MANGER UN DES SES PROPRES PIONS*/
            if (( (((damier[pions.X+pions.A][pions.Y+pions.B]==PION_J1)||
            (damier[pions.X+pions.A][pions.Y+pions.B]==DAME_J1))&&(tour==1))
            ||    (((damier[pions.X+pions.A][pions.Y+pions.B]==PION_J2)||
            (damier[pions.X+pions.A][pions.Y+pions.B]==DAME_J2))&&(tour==2)) )
            &&(action==2))
            {
              dessine_menu(21,2);
              gotoxy(47,6);
            ...
            if (( (((damier[pions.X+pions.A][pions.Y+pions.B]==PION_J1)||
            (damier[pions.X+pions.A][pions.Y+pions.B]==DAME_J1))&&(tour==2))
            ||    (((damier[pions.X+pions.A][pions.Y+pions.B]==PION_J2)||
            (damier[pions.X+pions.A][pions.Y+pions.B]==DAME_J2))&&(tour==1)) )
            &&(action==2))
            {
              ...
              choix=0;
              /*VERIFIER SI LE JOUEUR PEUT ENCORE CAPTURER UN PION*/
              if (curseur.Y>1)
              {
                if (curseur.X>1)
                {
                  if (((((damier[curseur.X-1][curseur.Y-1]==PION_J1)||(damier[curseur.X-1][curseur.Y-1]==DAME_J1))&&(tour==2))
                      ||(((damier[curseur.X-1][curseur.Y-1]==PION_J2)||(damier[curseur.X-1][curseur.Y-1]==DAME_J2))&&(tour==1)))
                      &&(damier[curseur.X-2][curseur.Y-2]==' ')) choix=1;
                }
                if (curseur.X<8)
                {
                  if (((((damier[curseur.X+1][curseur.Y-1]==PION_J1)||(damier[curseur.X+1][curseur.Y-1]==DAME_J1))&&(tour==2))
              ...
              if (choix==0)
              {
                ...
                textcolor(couleurs[tour]);
                gotoxy(47,8);
                printf("Le joueur %d passe la main.", tour);
                (tour==1)?(tour=2):(tour=1);
                textcolor(couleurs[tour]);
                gotoxy(47,9);
                printf("Tour joueur %d", tour);
                  ...
                  for (increment2=0 ; increment2<=9 ; increment2++)
                  {
                      ...
                      ||((damier[increment2][increment]==PION_J2)&&(increment==0)))
                    {
                      ...
                      if (action==0)
                      {
                        ...
                        printf("Bravo ! Le joueur %d",(tour==1)?2:1);///corrige
                        gotoxy(47,7);
                        printf("gagne une dame !");
                        gotoxy(47,8);
                        textcolor(couleurs[tour]);
            ...
            /*SI AUCUN DES CHOIX PRECEDANTS N'EST BON*/
            else if (action==2)
            {
              dessine_menu(31,4);
              gotoxy(47,6);
              ...
              gotoxy(47,8);
              printf("bouger que en diagonale, en");
              gotoxy(47,9);
              printf("avant et d'une case !");
              action=4;
            }
          }
          ...
          if (action==3)
          {
            dame=0;
            increment2=0;
            /*DETERMINE LA DIRECTION DANS LAQUELLE LE JOUEUR VEUT FAIRE AVANCER LA DAME*/
            if (curseur.X<pions.X) pions.A=-1;
            else pions.A=1;
            if (curseur.Y<pions.Y) pions.B=-1;
            else pions.B=1;
            for (increment=1 ; increment < (pions.B * (curseur.Y - pions.Y)) ; increment++)
            {
              /*SI SAUTE PLUSIEURS CASES APRES LE PREMIER PION MANGE*/
              if ((dame == 1)&&(damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==' ')) dame = 3;
              /*SI SAUTE AU-DESSUS D'UN DE SES PROPRES PIONS*/
              if (( (((damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==PION_J1)||
                (damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==DAME_J1))&&(tour==1))
                ||    (((damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==PION_J2)||
                (damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==DAME_J2))&&(tour==2)) )
                &&(dame==0)) dame=2;
              /*SI SAUTE AU-DESSUS D'UN PION ENNEMI*/
              if (( (((damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==PION_J1)||
              (damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==DAME_J1))&&(tour==2))
              ||    (((damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==PION_J2)||
              (damier[pions.X+(increment*pions.A)][pions.Y+(increment*pions.B)]==DAME_J2))&&(tour==1)) )
              && (dame!=2))
              {
                increment2++;
                dame = 1;
            ...
            if ((dame==0)&&(increment2==0))
            {
              damier[pions.X][pions.Y]=' ';
              if (tour==1) damier[curseur.X][curseur.Y]=DAME_J1;
              else damier[curseur.X][curseur.Y]=DAME_J2;
              dessine_menu(31,2);
              gotoxy(47,6);
              textcolor(couleurs[tour]);
            ...
            /*SI AVANCE PLUS TROP LOIN APRES PION MANGE*/
            if (dame==3)
            {
              dessine_menu(30,2);
              gotoxy(47,6);
              textcolor(couleurs[tour]);
              printf("On ne se d\x82place que d'une");
              gotoxy(47,7);
              printf("case apres le pion mang\x82 !");
              action=5;
            }
            /*S'IL SAUTE AU-DESSUS D'UN SEUL PION ENNEMI*/
            if ((dame==1)&&(increment2==1))
            {
              ...
              if (curseur.Y>1)
              {
                if (curseur.X>1)
                {
                  increment=-1;
                  increment2=-1;
                  while ((curseur.X+increment>1)&&(curseur.Y+increment2>1)
                         &&(damier[curseur.X+increment][curseur.Y+increment2]==' '))
                  {
                    increment--;
                    increment2--;
                  }
                  if (((((damier[curseur.X+increment][curseur.Y+increment2]==PION_J1)
                        ||(damier[curseur.X+increment][curseur.Y+increment2]==DAME_J1))&&(tour==2))
                     ||(((damier[curseur.X+increment][curseur.Y+increment2]==PION_J2)
                        ||(damier[curseur.X+increment][curseur.Y+increment2]==DAME_J2))&&(tour==1)))
                     &&(damier[curseur.X+increment-1][curseur.Y+increment2-1]==' ')) choix=1;
                }
                if (curseur.X<8)
                {
                  increment=1;
                  increment2=-1;
                  while ((curseur.X+increment<8)&&(curseur.Y+increment2>1)
                         &&(damier[curseur.X+increment][curseur.Y+increment2]==' '))
                  {
                    increment++;
                    increment2--;
              ...
              if (curseur.Y<8)
              {
                if (curseur.X>1)
                {
                  increment=-1;
                  increment2=1;
                  while ((curseur.X+increment>1)&&(curseur.Y+increment2<8)
                         &&(damier[curseur.X+increment][curseur.Y+increment2]==' '))
                  {
                    increment--;
                    increment2++;
                ...
                if (curseur.X<8)
                {
                  increment=1;
                  increment2=1;
                  while ((curseur.X+increment<8)&&(curseur.Y+increment2<8)
                         &&(damier[curseur.X+increment][curseur.Y+increment2]==' '))
                  {
                    increment++;
                    increment2++;
              ...
              while (choix!=0)
              {
                gotoxy(1,24);
                textcolor(couleurs[tour]);
                printf("Dame choisie : %c%d ",curseur.Y+65,curseur.X+1);
                gotoxy(47,8);
                printf("Voulez vous rejouer ?");
                gotoxy(47,9);
                /*OUI*/
    ...
    if (action==1)
    {
      ...
      if ((((damier[curseur.X][curseur.Y]==DAME_J1)
      || (damier[curseur.X][curseur.Y]==PION_J1))&&(tour==2))||
      ((((damier[curseur.X][curseur.Y]==DAME_J2)
      || (damier[curseur.X][curseur.Y]==PION_J2))&&(tour==1))&&(action==1)))
      {
        dessine_menu(28,1);
        gotoxy(47,6);
        textcolor(couleurs[tour]);
      ...
      if ((((damier[curseur.X][curseur.Y]==PION_J1)&&(tour==1))
      ||((damier[curseur.X][curseur.Y]==PION_J2)&&(tour==2)))
      &&(action==1))
      {
        pions.X=curseur.X;
        pions.Y=curseur.Y;
      ...
      /*SI CHOISIT UNE DAME*/
      if ((((damier[curseur.X][curseur.Y]==DAME_J1/*'\x01'*/)&&(tour==1))
      ||((damier[curseur.X][curseur.Y]==DAME_J2/*'\x02'*/)&&(tour==2)))
      &&(action==1))
      {
        pions.X=curseur.X;
        pions.Y=curseur.Y;
...
void initialise(char tableau[10][10])
{
  ...
  for (x=0 ; x<=9 ; x++)
  {
    for (y=0 ; y<=9 ; y++) tableau[y][x]=' ';
  }
  /*INITIALISATION PIONS ROUGES*/
  y=0;
  for (x=1 ; x<=9 ; x=x+2)
  {
    tableau[x][y]=PION_J1/*'\x05'*/;
    if ((x==9)&&(y==0))//permet d'initialiser la deuxieme ligne
    {
      x=-2;
      y=1;
    }
    if ((x==8)&&(y==1))//permet d'initialiser la troisieme ligne
    {
      x=-1;
      y=2;
    }
    if ((x==9)&&(y==2))//permet d'initialiser la quatrieme ligne
    {
      x=-2;
      y=3;
    }
  ...
  for (x=0 ; x<=9 ; x=x+2)
  {
    tableau[x][y]=PION_J2/*'\x06'*/;
    if ((x==8)&&(y==9))//permet d'initialiser la deuxieme ligne
    {
      x=-1;
      y=8;
    }
    if ((x==9)&&(y==8))//permet d'initialiser la troisieme ligne
    {
      x=-2;
      y=7;
    }
    if ((x==8)&&(y==7))//permet d'initialiser la quatrieme ligne
    {
      x=-1;
      y=6;
    }
